...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EvolveRun — Adaptive AI endurance coach" },
      {
        name: "description",
        content:
          "Connect Strava to Claude, ChatGPT or Gemini. Adaptive training plans, zone analysis and recovery debriefs from your real data.",
      },
      { property: "og:title", content: "EvolveRun — Adaptive AI endurance coach" },
      {
        property: "og:description",
        content:
          "Connect Strava to your AI of choice. Real answers about your training from your real data.",
      },
